...
\begin{titlepage}
    ...
    {\fontsize{36}{50}                                              %Size of the book
        \selectfont \textbf{Funciones}}\\[0.5cm]       %Name of the book
    {\fontsize{36}{50}                                              %Size of the book
        \selectfont \textbf{Funciones}}\\[0.5cm]                %Name of the book
...
\subsection{CURRENT\_TIME()}
                 ...
                 \begin{figure}[h!]
                    ...
                    \end{figure}
                    \clearpage
\subsection{YEAR(FECHA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{4}
                    \end{figure}
\subsection{MONTH(FECHA)}
                 ...
                 \begin{figure}[h!]
                    ...
                    \end{figure}
                    \clearpage
\subsection{MONTHNAME(FECHA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{6}
                    \end{figure}
\subsection{QUARTER(FECHA)}
...
\subsection{MINUTE(HORA)}
                 ...
                 \begin{figure}[h!]
                    ...
                    \end{figure}
\clearpage
\subsection{SECOND(HORA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{10}
                    \end{figure}
\subsection{DAYNAME(FECHA)}
...
\subsection{BIN(N)}
                 ...
                 \begin{figure}[h!]
                    ...
                    \end{figure}
\subsection{CONCAT(cadena1,cadena2)}
...
\subsection{OCT(N)}
                 ...
                 \begin{figure}[h!]
                    ...
                    \end{figure}
                    \clearpage
\subsection{LOWER(CADENA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{h}
                    \end{figure}
\subsection{LCASE(CADENA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{h-1.png}
                    \end{figure}
\clearpage
\subsection{UPPER(CADENA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{i}
                    \end{figure}

\subsection{UCASE(CADENA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{i-1.png}
                    \end{figure}
\clearpage
\subsection{LEFT(CADENA,N)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{j}
                    \end{figure}

\subsection{RIGHT(CADENA,N)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{k}
                    \end{figure}
                    \clearpage
\subsection{LENGTH(CADENA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{l}
                    \end{figure}
\subsection{LTRIM(CADENA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{m}
                    \end{figure}
\clearpage
\subsection{RTRIM(CADENA)}
...
\subsection{REPEAT(CADENA,N)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{o}
                    \end{figure}
                    \clearpage
\subsection{REVERSE(CADENA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{p}
                    \end{figure}


\subsection{SUBSTRING(CADENA,N)}
                 ...
                 \begin{figure}[h!]
                    ...
                    \end{figure}
                    \clearpage
\subsection{SUBSTRING(CADENA,N,M)}
...
\subsection{SPACE(N)}
                 ...
                 \begin{figure}[h!]
                    ...
                    \end{figure}
\clearpage
\subsection{LOCATE(SUBCADENA,CADENA)}

                 \begin{figure}[h!]
                        \centering
                        \includegraphics[width=0.6\textwidth]{t}
                    \end{figure}
